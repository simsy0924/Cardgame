...
// doDrawPhase 훅: drawOne() 이후 renderAll() 보장
// drawOne()은 sendGameState()만 호출하고 renderMyHand()를 안 해서 화면 미반영
(function _patchDoDrawPhase() {
  const _orig = typeof doDrawPhase === 'function' ? doDrawPhase : null;
  if (!_orig) return;
  doDrawPhase = function() {
    _orig.apply(this, arguments);
    renderAll();
  };
})();
